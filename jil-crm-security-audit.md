...
<NamedCredential xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <protocol>NoAuthentication</protocol> <!-- External Credential handles auth -->
</NamedCredential>
```
...
Say the word and I'll start implementing fixes in priority order, beginning with C-4 (converting Lookups to Master-Detail) since that's the foundation everything else builds on and must happen before any data exists in the org.
